        ...
        <div className='flex flex-col space-y-5 p-4 w-full px-10 mainContent'>
          <div className='flex flex-col items-center py-40 h-auto space-y-10'>
            <p className='text-white text-center text-lg mb-4 sm:w-full md:w-3/4'>
              The SETUP Management System is a web-based platform designed for
              the DOST (Department of Science and Technology) Small Enterprise
              Technology Upgrading Program (SETUP) in Davao del Norte,
              Philippines. This system streamlines the process of managing
              funding assistance for small enterprises.
            </p>
            ...
            <ul className='text-white text-lg text-left space-y-2 sm:w-full md:w-3/4'>
              <li>
                ...
                personal and business documents directly through the system. The
                system also verifies applicant accounts and identifies
                enterprise levels.
              </li>
              <li>
                <strong>Cooperator/Client Support:</strong> Provides an
                organized storage system for cooperator/client data. Cooperators
                can submit quarterly reports and project data sheets to track
                business progress and monitor their refund payments. They can
                also view payment status, remaining balances, and fund
                utilization.
              </li>
              <li>
                <strong>Staff Operations:</strong> Supports staff in recording,
                calculating, and monitoring funding assistance. Staff can manage
                cooperator business information, record fund releases, and
                monitor funding status, as well as generate various project
                reports.
              </li>
              <li>
                <strong>Admin Oversight:</strong> Enables administrative users
                to access, review, and manage all cooperator and client data,
                including project lists and user accounts. The system also
                performs quarterly calculations for assets, employment,
                production, and sales, determines DOST-SETUP coverage amounts,
                and calculates monthly payments.
              </li>
            </ul>
            <div>
              <LazyLoadImage
