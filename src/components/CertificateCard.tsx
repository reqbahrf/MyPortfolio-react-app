...
const CertificateCard: React.FC<CertificateCardProps> = ({
  ...
  return (
    <motion.div
      className='group certificate-card w-[95dvw] md:w-[38rem] h-[13rem] rounded-[20px] shadow-lg bg-gray-800 overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-xl flex flex-row'
      style={{
