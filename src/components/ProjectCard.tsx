  ...
  (
    ...
    return (
      <motion.div
        ...
        className='group flex flex-col  w-[28rem] h-[28rem] rounded-[20px] shadow-lg bg-gray-800 transition-all duration-300 hover:shadow-xl relative cursor-pointer overflow-hidden'
      >
        <motion.div
