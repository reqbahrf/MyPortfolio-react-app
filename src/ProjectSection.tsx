...
const ProjectSection = () => {
  ...
  React.useEffect(() => {
    ...
    if (javaProjectModal) {
      javaProjectModal.addEventListener(
        "scroll",
    ...
    if (figmaProjectModal) {
      figmaProjectModal.addEventListener(
        "scroll",
    ...
    if (photoProjectModal) {
      photoProjectModal.addEventListener(
        "scroll",
    ...
    return () => {
      if (javaProjectModal) {
        javaProjectModal.removeEventListener(
          "scroll",
          () => handleScroll(javaProjectModal),
        );
      }
      if (figmaProjectModal) {
        figmaProjectModal.removeEventListener(
          "scroll",
          () => handleScroll(figmaProjectModal),
        );
      }
      if (photoProjectModal) {
        photoProjectModal.removeEventListener(
          "scroll",
          () => handleScroll(photoProjectModal),
        );
      }
